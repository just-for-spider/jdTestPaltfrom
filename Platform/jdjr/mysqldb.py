...
class MySQL(object):
    ...
    def init_app(self, app):
        self.app = app
        self.app.config.setdefault('MYSQL_DATABASE_HOST', '172.25.62.234')
        self.app.config.setdefault('MYSQL_DATABASE_PORT', 3306)
        self.app.config.setdefault('MYSQL_DATABASE_USER', "root")
        self.app.config.setdefault('MYSQL_DATABASE_PASSWORD', "123456")
        self.app.config.setdefault('MYSQL_DATABASE_DB', "performance")
